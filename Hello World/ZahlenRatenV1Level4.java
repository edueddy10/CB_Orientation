...
public class ZahlenRatenV1Level4 {
    public static void main(String[] args) {
        ...
        int randomNumberLv3 = 30/*r.nextInt(101)*/;
        ...
        if (userStartsFirst) {
            ...
            //Benutzer ein und Ausgaben //
                ...
                if (pickNumberLv3 >= randomNumberLv3 - Math.abs(-3) && pickNumberLv3 <= randomNumberLv3 - Math.abs(-1))    {
